...
SOPCINFO_FILE := C:/Users/clark/Documents/eie-y2/info-processing-labs/PROJECT_NIOS/platform-designer-flash/PROJECT_NIOS.sopcinfo
...
# Design Name 
# setting SOPC_NAME is PROJECT_NIOS
SOPC_NAME := PROJECT_NIOS
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1410f8
SOPC_SYSID_FLAG += --sidp=0x1410f8
ELF_PATCH_FLAG  += --sidp 0x1410f8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1741375806
SOPC_SYSID_FLAG += --timestamp=1741375806
ELF_PATCH_FLAG  += --timestamp 1741375806
